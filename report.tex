...
\begin{tikzpicture}
  \begin{axis}[width=15cm, height=8cm, legend pos=outer north east, grid = major, grid style={dashed, gray!30}]
    \addplot [thick, mark = none, red]table [x=t, y=x1, col sep=comma] {points_alpha0.0.csv};
    \addlegendentry{$x_1$}
    \addplot [only marks, mark = x, black]table [x=t, y=x1, col sep=comma] {analitic_points_alpha0.0.csv};
    \addlegendentry{$x_1^t$}
    \addplot [thick, mark = none, blue]table [x=t, y=x2, col sep=comma] {points_alpha0.0.csv};
    \addlegendentry{$x_2$}
    \addplot [thick, mark = none, green]table [x=t, y=p1, col sep=comma] {points_alpha0.0.csv};
    \addlegendentry{$p_1$}
    \addplot [thick, mark = none, black]table [x=t, y=p2, col sep=comma] {points_alpha0.0.csv};
    \addlegendentry{$p_2$}
  \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[width=15cm, height=8cm, legend pos=outer north east, grid = major, grid style={dashed, gray!30}]
    \addplot [thick, mark = none, red]table [x=t, y=x1, col sep=comma] {points_alpha0.1.csv};
    \addlegendentry{$x_1$}
    \addplot [thick, mark = none, blue]table [x=t, y=x2, col sep=comma] {points_alpha0.1.csv};
    \addlegendentry{$x_2$}
    \addplot [thick, mark = none, green]table [x=t, y=p1, col sep=comma] {points_alpha0.1.csv};
    \addlegendentry{$p_1$}
    \addplot [thick, mark = none, black]table [x=t, y=p2, col sep=comma] {points_alpha0.1.csv};
    \addlegendentry{$p_2$}
  \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[width=15cm, height=8cm, legend pos=outer north east, grid = major, grid style={dashed, gray!30}]
    \addplot [thick, mark = none, red]table [x=t, y=x1, col sep=comma] {points_alpha1.0.csv};
    \addlegendentry{$x_1$}
    \addplot [thick, mark = none, blue]table [x=t, y=x2, col sep=comma] {points_alpha1.0.csv};
    \addlegendentry{$x_2$}
    \addplot [thick, mark = none, green]table [x=t, y=p1, col sep=comma] {points_alpha1.0.csv};
    \addlegendentry{$p_1$}
    \addplot [thick, mark = none, black]table [x=t, y=p2, col sep=comma] {points_alpha1.0.csv};
    \addlegendentry{$p_2$}
  \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[width=15cm, height=8cm, legend pos=outer north east, grid = major, grid style={dashed, gray!30}]
    \addplot [thick, mark = none, red]table [x=t, y=x1, col sep=comma] {points_alpha5.1.csv};
    \addlegendentry{$x_1$}
    \addplot [thick, mark = none, blue]table [x=t, y=x2, col sep=comma] {points_alpha5.1.csv};
    \addlegendentry{$x_2$}
    \addplot [thick, mark = none, green]table [x=t, y=p1, col sep=comma] {points_alpha5.1.csv};
    \addlegendentry{$p_1$}
    \addplot [thick, mark = none, black]table [x=t, y=p2, col sep=comma] {points_alpha5.1.csv};
    \addlegendentry{$p_2$}
  \end{axis}
\end{tikzpicture}
